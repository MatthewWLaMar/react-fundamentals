    ...
    return (
        <div className="main">
            ...
            <ul>
                ...
                <li>
                    Refact the text on this page and make this your own portfolio 
                    project.
                </li>
                <li>
                    This appp simply scratches the surface on what is possible 
                    with React.
                </li>
                <li>
                    We have tried to collect the very best resources for this app,
                    and we have cited those <Link to="/resources">here</Link>
                </li>
                <li>
                    The set up for this app might be the most confusing part. Hang
                    in there..
                </li>
                <li>
