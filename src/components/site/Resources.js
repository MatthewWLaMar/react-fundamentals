  ...
  return (
    <div className="main">
      <div className="mainDiv">
        ...
        <p>
          Below are some of the resources that we throughout this app. Note:
        ...
        <ul>
          <li>
            <a
              href="https://react.js.org/docs/getting-started.html"
              target="_blank"
            >
              The Official Docs
            </a>
          ...
          <li>
            <a
              href="https://www.udemy.com/course/react-reduct/"
              target="_blank"
            >
